...
template<typename T,int N> struct my_map_allocator{
...
//std::map
 ...
 std::map<int,long double,std::less<int>,my_map_allocator<std::pair<const int, long double>,10>> m_map_my_alloc;  //my alloc 
